	...
	<div class="_modal-search-container flex justify-center">
		...
		<div class="text-center bg-grey-light md:p-8 w-full md:w-3/5">
			...
			<form role="search" method="get" class="flex flex-wrap mb-16 group" action="<?php echo esc_url(home_url('/')); ?>">
				...
				<input type="search" class="search-input group-hover:shadow-md h-14" placeholder="<?php _e('Search something here...', 'canva-frontend'); ?>" value="<?php echo get_search_query(); ?>" name="s" title="<?php echo _e('Search', 'canva-frontend'); ?>" autofocus>
