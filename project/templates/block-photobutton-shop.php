...
<div id="<?php echo esc_attr($id); ?>" class="wp-block-photobutton">
		...
		<?php if ($link_wrap) : ?>
			...
			<div class="_photobutton _pb-shop _layer-wrap <?php echo esc_attr($className); ?> <?php echo esc_attr($isdark); ?>">
				...
				<!-- Layer content -->
				<div class="_layer-content absolute flex flex-wrap items-baseline bottom-0 p-8">
					...
					<?php if ($photobutton_title) : ?>
						<h3 class="_title h2 uppercase mb-0 text-white"><?php echo $photobutton_title; ?></h3>
					<?php endif; ?>
					<?php if ($photobutton_subtitle) : ?>
						<span class="_subtitle h5 mt-2 mb-0"><?php echo $photobutton_subtitle; ?></span>
					<?php endif; ?>
					...
					<?php if ($link_wrap) : ?>
						<span class="<?php echo esc_attr($className) . ' ' . esc_attr($modal_class) . ' ' . esc_attr($button); ?>" onclick="ga('send', 'event', 'Action-Link', 'Photobutton', '<?php echo $track_title; ?>');" <?php echo $modal_data_contet; ?>><?php echo esc_html($button_title); ?></span>
					<?php else: ?>
