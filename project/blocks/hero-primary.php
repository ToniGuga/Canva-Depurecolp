...
<?php
	...
	if (get_field('toptitle') || get_field('title') || get_field('subtitle') || get_field('action_link')) {
		...
		$layer_content_output = '
				<div class="wp-block-columns h-full items-end">
					<div class="wp-block-column col-span-12 md:col-span-9 lg:col-span-8 xl:col-span-6 pt-16 lg:pt-24">

						<div class="_content-wrap isdark pb-12 lg:pb-16">
							...
							<div class="_hero-primary-content fs-lead max-w-48ch mt-8">' . get_field('content') . '</div>';
							if(get_field('action_link')) {
							$layer_content_output .= '<div class="_hero-button-box pt-4">
								' . $cta . '
								' . $cta_2 . '
							</div>';
							}
	...
	canva_the_layer([
		'layer_type' => '_hero _hero-primary flex-wrap', // _hero, _card, _photobutton
		...
		'layer_visual_class' => 'relative order-2 md:order-1 md:absolute h-64 md:h-auto',

		'layer_bg' => 'on',
		'layer_bg_class' => 'md:top-8',
		...
		'layer_content' => 'on',
		'layer_content_class' => '_main__section relative w-full order-1 md:order-2 bg-primary md:bg-transparent',
